      ...
      <div className="site-container py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-[14px] text-white/70 leading-relaxed max-w-sm font-normal">
          ...
          <div className="md:col-span-3">
            <h3 className="text-xs tracking-[0.2em] uppercase text-amber-300 font-bold mb-5">
              Explore
            </h3>
            <nav className="flex flex-col gap-2.5 text-[14px]" aria-label="Footer navigation">
              {[
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <address className="not-italic space-y-2 text-[14px] text-white/70 font-normal">
