  ...
  return (
    <section className="py-24 md:py-32 bg-[#F0EAE0]">
      <div className="site-container max-w-3xl text-center">
        ...
        <p className="text-base md:text-lg text-[#5C5650] leading-relaxed max-w-2xl mx-auto mb-10 font-normal">
        ...
        <div className="pt-6 border-t border-[#D8D0C5]/80 inline-block">
