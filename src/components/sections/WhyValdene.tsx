...
export function WhyValdene() {
  return (
    <section className="py-16 md:py-24 bg-[#F0EAE0] border-t border-[#D8D0C5]">
      <div className="site-container max-w-3xl text-center">
        ...
        <p className="text-base md:text-lg text-[#5C5650] leading-relaxed max-w-xl mx-auto mb-8 font-normal">
        ...
        <div className="pt-4 border-t border-[#D8D0C5] inline-block">
          <span className="font-serif text-xl font-bold text-[#2B2623] block">Bob & Linda</span>
