  ...
  return (
    <section className="py-20 md:py-28 bg-[#F0EAE0]">
      <div className="site-container text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch gap-8 max-w-2xl mx-auto pb-4">
          {hotel.awards.map((award, i) => (
            <div key={i} className="bg-white p-6 sm:p-8 border border-[#D8D0C5] shadow-xs flex-1 flex flex-col items-center justify-between text-center">
