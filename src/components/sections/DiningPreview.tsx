  ...
  return (
    <section className="py-16 md:py-24 bg-[#FAF7F2] border-t border-[#D8D0C5]">
      <div className="site-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 bg-white border border-[#D8D0C5] overflow-hidden mb-10 shadow-xs">
          <div className="lg:col-span-6 aspect-[4/3] lg:aspect-auto bg-[#F0EAE0] relative">
            <img
          ...
          <div className="lg:col-span-6 p-6 sm:p-10 flex flex-col justify-center">
            ...
            <h3 className="font-serif text-2xl md:text-3xl text-[#2B2623] font-bold mb-3">
              Breakfast
            </h3>
            <p className="text-base text-[#5C5650] leading-relaxed mb-6 font-normal">
              {dining.breakfast.description}
            </p>
            <div className="bg-[#FAF7F2] p-4 border border-[#D8D0C5]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          <div className="bg-white border border-[#D8D0C5] p-6 flex flex-col justify-between shadow-xs">
            <div>
              <span className="text-xs uppercase tracking-widest text-[#7A2332] font-bold block mb-2">
                Evening Menu
              </span>
              <h4 className="font-serif text-xl md:text-2xl text-[#2B2623] font-bold mb-3">Evening Meal</h4>
              <p className="text-sm md:text-base text-[#5C5650] leading-relaxed mb-4 font-normal">
          ...
          <div className="bg-[#2B2623] text-white p-6 flex flex-col justify-between shadow-xs">
            <div>
              <span className="text-xs uppercase tracking-widest text-amber-300 font-bold block mb-2">
                Licensed Bar & Lounge
              </span>
              <h4 className="font-serif text-xl md:text-2xl text-white font-bold mb-3">The Bar</h4>
              <p className="text-sm md:text-base text-white/90 leading-relaxed mb-4 font-normal">
