    ...
    <section className="relative h-[72vh] min-h-[480px] max-h-[640px] flex items-center justify-center text-white overflow-hidden bg-[#2B2623]">
      ...
      <div className="relative z-10 site-container text-center flex flex-col items-center py-10">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
          <SecondaryButton to="/offers" light className="w-full sm:w-auto min-w-[210px] text-sm px-9 py-4 bg-[#2B2623]/60 backdrop-blur-xs border-white/80 text-white hover:bg-white hover:text-[#2B2623] font-bold">
            View Special Offers
          </SecondaryButton>
